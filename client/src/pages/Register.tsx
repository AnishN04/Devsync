  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-dark relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-indigo-600/10 rounded-full blur-[160px] animate-pulse" />
        <div className="absolute bottom-[-20%] left-[-10%] w-[60%] h-[60%] bg-violet-600/10 rounded-full blur-[160px] animate-pulse delay-1000" />
      ...
      >
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-heading font-black text-white mb-3 tracking-tighter uppercase">Join Grid</h1>
          <p className="text-slate-500 font-bold uppercase tracking-[0.4em] text-[10px]">Initialize Contributor Protocol</p>
        </div>
        ...
        <div className="glass-card p-10 bg-bg-card/40 backdrop-blur-3xl border-white/5 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] relative overflow-hidden group">
          ...
          <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-indigo-500/10 rounded-full blur-[60px] group-hover:bg-indigo-500/20 transition-colors duration-1000" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative">
            <div className="space-y-3">
              ...
              <div className="relative group/input">
                <User className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within/input:text-indigo-400 transition-colors" size={20} />
                <input 
                  type="text" 
                  value={name}
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] ml-1">Network Address</label>
              <div className="relative group/input">
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] ml-1">Secure Keyphrase</label>
              <div className="relative group/input">
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-black py-4 rounded-2xl flex items-center justify-center gap-4 transition-all shadow-[0_20px_40px_-10px_rgba(99,102,241,0.5)] active:scale-95 disabled:opacity-50 group font-heading tracking-[0.2em] uppercase text-xs mt-4"
            >
              {isLoading ? (
          ...
          <div className="mt-10 relative">
            ...
            >
              <Github size={20} className="text-slate-400" /> Sign up with GitHub
            </button>
          </div>
        </div>

        <p className="text-center mt-10">
          <span className="text-slate-500 text-[10px] font-black uppercase tracking-widest mr-2">Core Access Active?</span>
          <Link to="/login" className="text-indigo-400 font-black uppercase text-[10px] tracking-widest hover:text-indigo-300 transition-colors border-b border-indigo-500/30 pb-1">Authenticate Here</Link>
        </p>
      </motion.div>
    </div>
  );
